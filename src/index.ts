...
function getRecipients() {
  ...
  if (!solana || !base) {
    throw new Error(
      "WALLET_ADDRESS (and/or WALLET_ADDRESS_BASE) env var is not set",
    );
  }
  return { solana, base };
}
...
app.get("/", (c) => {
  ...
  return c.json({
    ...
    description:
      ...
      "AI agent intelligence services powered by real 4G/5G mobile proxies.",
    version: "2.0.0",
    endpoints: [
      {
        method: "POST",
        path: "/api/scrape",
        description:
          "E-Commerce Price & Stock Monitor — Amazon/eBay/generic product pages",
        price: "0.002 USDC (Base)",
      },
      {
        method: "GET",
        path: "/api/run",
        description:
          "Google Maps Lead Generator — search businesses by category + location",
        price: "0.005 USDC",
      },
      {
        method: "GET",
        path: "/api/details",
        description:
          "Google Maps Place Details — detailed business info by Place ID",
        price: "0.005 USDC",
      },
      {
        method: "GET",
        path: "/api/serp",
        description:
          "Mobile SERP Scraper — Google organic results (title, link, snippet) via Playwright + iPhone 14 stealth",
        price: "0.003 USDC (Base)",
      },
      {
        method: "GET",
        path: "/api/jobs",
        description:
          "Get job listings (Indeed/LinkedIn) with salary + date + proxy metadata",
      },
      {
        method: "GET",
      ...
      {
        method: "GET",
        path: "/api/reviews/:place_id",
        description: "Fetch Google reviews by Place ID",
        price: "0.02 USDC",
      },
      {
        method: "GET",
        path: "/api/business/:place_id",
        description: "Get business details + review summary",
        price: "0.01 USDC",
      },
      {
        method: "GET",
        path: "/api/reviews/summary/:place_id",
        description: "Get review summary stats",
        price: "0.005 USDC",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        description: "Find company employees by title",
        price: "0.01 USDC",
      },
      {
        method: "GET",
      ...
      {
        method: "GET",
        path: "/api/reddit/subreddit/:name",
        description: "Browse subreddit posts",
        price: "0.005 USDC",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        description: "Full Instagram analysis with AI vision",
        price: "0.15 USDC",
      },
      {
        method: "GET",
        path: "/api/instagram/analyze/:username/images",
        description: "AI vision analysis of Instagram images",
        price: "0.08 USDC",
      },
      {
        method: "GET",
        path: "/api/instagram/audit/:username",
        description: "Instagram authenticity audit",
        price: "0.05 USDC",
      },
      {
        method: "GET",
        path: "/api/airbnb/search",
        description: "Search Airbnb listings by location",
        price: "0.02 USDC",
      },
      {
        method: "GET",
        path: "/api/airbnb/listing/:id",
        description: "Get detailed Airbnb listing",
        price: "0.01 USDC",
      },
      {
        method: "GET",
        path: "/api/airbnb/reviews/:listing_id",
        description: "Get Airbnb listing reviews",
        price: "0.01 USDC",
      },
      {
        method: "GET",
        path: "/api/airbnb/market-stats",
        description: "Airbnb market statistics",
        price: "0.05 USDC",
      },
      {
        method: "GET",
      ...
      },
      {
        method: "GET",
        path: "/api/trending",
        description: "Trending topics intelligence",
        price: "0.01 USDC",
      },
    ],
    pricing: {
      ...
      networks: [
        {
          network: "solana",
          chainId: "solana:BVLVkVKhwd8WCT7ypkztCYenLReGA7sj1SejcieVX9A3",
